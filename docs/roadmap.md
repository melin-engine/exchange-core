...
| 21 | FIX protocol gateway | High | High | ★★☆☆☆ | Institutional clients expect FIX (4.2/4.4). Gateway translates FIX ↔ native binary. Large spec surface but can start with NewOrderSingle/ExecutionReport subset. |
