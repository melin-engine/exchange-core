...
/// keys (e.g. `live_order_ids`). Astenn's extendible hashing grows the
/// directory based on lifetime unique inserts; hashbrown's Robin Hood
/// + backshift deletion keeps capacity tracking live entries.
